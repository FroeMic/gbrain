...
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_oI6D8YpG_js from '../admin/dist/assets/index-oI6D8YpG.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  ...
  "/admin/assets/index-oI6D8YpG.js": { path: A_1_assets_index_oI6D8YpG_js as unknown as string, mime: "application/javascript; charset=utf-8" },
